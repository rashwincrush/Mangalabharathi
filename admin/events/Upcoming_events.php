...
// Prepare filter parameters for upcoming events
$filter = [
    'year' => $_GET['year'] ?? 'all',
    'category' => $_GET['category'] ?? 'all',
    'search' => $_GET['search'] ?? '',
    'status' => 'upcoming'  // Force upcoming events only
];
...
try {
    ...
    error_log("Error retrieving upcoming events: " . $e->getMessage());
    $events_result = [
        'events' => [],
        'pagination' => [
            'total_records' => 0,
...
<head>
    ...
    <title>Upcoming Events - <?php echo SITE_NAME; ?></title>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="text-primary mb-0">Upcoming Events</h2>
                    </div>
                    <div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php if (empty($events_result['events'])): ?>
                                        <tr>
                                            <td colspan="7" class="text-center">No upcoming events found.</td>
                                        </tr>
                                    <?php else: ?>
                                        <?php foreach ($events_result['events'] as $event): ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($event['expected_beneficiaries'] ?? 0); ?></td>
                                                <td><?php echo number_format($event['volunteers_required'] ?? 0); ?></td>
                                                <td>
